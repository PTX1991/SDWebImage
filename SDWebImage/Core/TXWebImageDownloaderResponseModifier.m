...
@interface TXWebImageDownloaderResponseModifier ()

@property (nonatomic, copy, nonnull) TXWebImageDownloaderResponseModifierBlock block;

@end

@implementation TXWebImageDownloaderResponseModifier

- (instancetype)initWithBlock:(TXWebImageDownloaderResponseModifierBlock)block {
    self = [super init];
    if (self) {
        self.block = block;
    }
...
+ (instancetype)responseModifierWithBlock:(TXWebImageDownloaderResponseModifierBlock)block {
    TXWebImageDownloaderResponseModifier *responseModifier = [[TXWebImageDownloaderResponseModifier alloc] initWithBlock:block];
...
@implementation TXWebImageDownloaderResponseModifier (Conveniences)
