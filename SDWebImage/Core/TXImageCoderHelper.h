 ...
 */
@interface TXImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<TXImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<TXImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
