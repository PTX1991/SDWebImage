 ...
 */
@protocol TXImageTransformer <NSObject>
 ...
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<TXImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<TXImageTransformer>> *)transformers;
