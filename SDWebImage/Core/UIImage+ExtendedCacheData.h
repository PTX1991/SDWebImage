...
/**
 ...
 @note The disk cache preserve both of the data and extended data with the same cache key. For manual query, use the `TXDiskCache` protocol method `extendedDataForKey:` instead.
