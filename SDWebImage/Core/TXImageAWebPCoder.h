...
@interface TXImageAWebPCoder : TXImageIOAnimatedCoder <SDProgressiveImageCoder, TXAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) TXImageAWebPCoder *sharedCoder;
