...
@interface TXImageHEICCoder : TXImageIOAnimatedCoder <SDProgressiveImageCoder, TXAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) TXImageHEICCoder *sharedCoder;
