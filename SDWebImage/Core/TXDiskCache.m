...
static NSString * const TXDiskCacheExtendedAttributeName = @"com.hackemist.TXDiskCache";

@interface TXDiskCache ()
...
- (instancetype)initWithCachePath:(NSString *)cachePath config:(nonnull TXImageCacheConfig *)config {
    if (self = [super init]) {
...
- (NSData *)extendedDataForKey:(NSString *)key {
    ...
    NSData *extendedData = [TXFileAttributeHelper extendedAttribute:TXDiskCacheExtendedAttributeName atPath:cachePathForKey traverseLink:NO error:nil];
...
- (void)setExtendedData:(NSData *)extendedData forKey:(NSString *)key {
    ...
    if (!extendedData) {
        // Remove
        [TXFileAttributeHelper removeExtendedAttribute:TXDiskCacheExtendedAttributeName atPath:cachePathForKey traverseLink:NO error:nil];
    } else {
        // Override
        [TXFileAttributeHelper setExtendedAttribute:TXDiskCacheExtendedAttributeName value:extendedData atPath:cachePathForKey traverseLink:NO overwrite:YES error:nil];
    }
}
...
- (void)removeExpiredData {
    ...
    switch (self.config.diskCacheExpireType) {
        case TXImageCacheConfigExpireTypeAccessDate:
            cacheContentDateKey = NSURLContentAccessDateKey;
            break;
        case TXImageCacheConfigExpireTypeModificationDate:
            cacheContentDateKey = NSURLContentModificationDateKey;
            break;
        case TXImageCacheConfigExpireTypeCreationDate:
            cacheContentDateKey = NSURLCreationDateKey;
            break;
        case TXImageCacheConfigExpireTypeChangeDate:
...
- (nullable NSString *)cachePathForKey:(nullable NSString *)key inPath:(nonnull NSString *)path {
    NSString *filename = TXDiskCacheFileNameForKey(key);
...
static inline NSString * _Nonnull TXDiskCacheFileNameForKey(NSString * _Nullable key) {
