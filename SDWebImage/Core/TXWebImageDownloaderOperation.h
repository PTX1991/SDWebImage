...
/**
 ...
 For the description about these methods, see `TXWebImageDownloaderOperation`
 ...
 */
@protocol TXWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
// These operation-level config was inherited from downloader. See `TXWebImageDownloaderConfig` for documentation.
...
/**
 The download operation class for TXWebImageDownloader.
 */
@interface TXWebImageDownloaderOperation : NSOperation <TXWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) TXWebImageDownloaderOptions options;
...
/**
 *  Initializes a `TXWebImageDownloaderOperation` object
 *
 *  @see TXWebImageDownloaderOperation
 *
