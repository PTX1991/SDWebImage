...
@implementation TXWebImageTransition
...
@implementation TXWebImageTransition (Conveniences)

+ (TXWebImageTransition *)fadeTransition {
    return [self fadeTransitionWithDuration:0.5];
}

+ (TXWebImageTransition *)fadeTransitionWithDuration:(NSTimeInterval)duration {
    TXWebImageTransition *transition = [TXWebImageTransition new];
...
+ (TXWebImageTransition *)flipFromLeftTransition {
    return [self flipFromLeftTransitionWithDuration:0.5];
}

+ (TXWebImageTransition *)flipFromLeftTransitionWithDuration:(NSTimeInterval)duration {
    TXWebImageTransition *transition = [TXWebImageTransition new];
    transition.duration = duration;
#if SD_UIKIT
...
+ (TXWebImageTransition *)flipFromRightTransition {
    return [self flipFromRightTransitionWithDuration:0.5];
}

+ (TXWebImageTransition *)flipFromRightTransitionWithDuration:(NSTimeInterval)duration {
    TXWebImageTransition *transition = [TXWebImageTransition new];
    transition.duration = duration;
#if SD_UIKIT
...
+ (TXWebImageTransition *)flipFromTopTransition {
    return [self flipFromTopTransitionWithDuration:0.5];
}

+ (TXWebImageTransition *)flipFromTopTransitionWithDuration:(NSTimeInterval)duration {
    TXWebImageTransition *transition = [TXWebImageTransition new];
    transition.duration = duration;
#if SD_UIKIT
...
+ (TXWebImageTransition *)flipFromBottomTransition {
    return [self flipFromBottomTransitionWithDuration:0.5];
}

+ (TXWebImageTransition *)flipFromBottomTransitionWithDuration:(NSTimeInterval)duration {
    TXWebImageTransition *transition = [TXWebImageTransition new];
    transition.duration = duration;
#if SD_UIKIT
...
+ (TXWebImageTransition *)curlUpTransition {
    return [self curlUpTransitionWithDuration:0.5];
}

+ (TXWebImageTransition *)curlUpTransitionWithDuration:(NSTimeInterval)duration {
    TXWebImageTransition *transition = [TXWebImageTransition new];
    transition.duration = duration;
#if SD_UIKIT
...
+ (TXWebImageTransition *)curlDownTransition {
    return [self curlDownTransitionWithDuration:0.5];
}

+ (TXWebImageTransition *)curlDownTransitionWithDuration:(NSTimeInterval)duration {
    TXWebImageTransition *transition = [TXWebImageTransition new];
    transition.duration = duration;
#if SD_UIKIT
