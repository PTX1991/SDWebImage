...
typedef NSURLRequest * _Nullable (^TXWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol TXWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface TXWebImageDownloaderRequestModifier : NSObject <TXWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull TXWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull TXWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface TXWebImageDownloaderRequestModifier (Conveniences)
