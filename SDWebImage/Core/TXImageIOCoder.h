...
/**
 ...
 For a full GIF support, we recommend `TXAnimatedImageView` to keep both CPU and memory balanced.
 ...
 */
@interface TXImageIOCoder : NSObject <SDProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) TXImageIOCoder *sharedCoder;
