...
@interface TXWebImageDownloaderRequestModifier ()

@property (nonatomic, copy, nonnull) TXWebImageDownloaderRequestModifierBlock block;

@end

@implementation TXWebImageDownloaderRequestModifier

- (instancetype)initWithBlock:(TXWebImageDownloaderRequestModifierBlock)block {
    self = [super init];
    if (self) {
        self.block = block;
    }
...
+ (instancetype)requestModifierWithBlock:(TXWebImageDownloaderRequestModifierBlock)block {
    TXWebImageDownloaderRequestModifier *requestModifier = [[TXWebImageDownloaderRequestModifier alloc] initWithBlock:block];
...
@implementation TXWebImageDownloaderRequestModifier (Conveniences)
