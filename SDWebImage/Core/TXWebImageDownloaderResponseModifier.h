...
typedef NSURLResponse * _Nullable (^TXWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol TXWebImageDownloaderResponseModifier <NSObject>
...
/// @note If nil is returned, the image download will marked as cancelled with error `TXWebImageErrorInvalidDownloadResponse`
 ...
 */
@interface TXWebImageDownloaderResponseModifier : NSObject <TXWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull TXWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull TXWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface TXWebImageDownloaderResponseModifier (Conveniences)
